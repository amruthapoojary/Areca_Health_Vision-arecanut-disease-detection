...
function StemBleedingRecommendation() {
 ...
 <div className="recommendation-container" style={{ padding: "20px" }}>
      ...
      <p className="disease-description">
        ...
        It leads to reddish-brown liquid oozing from the stem. If left untreated, it can cause plant death.
      </p>
      ...
      <div className="card-grid">
        ...
        <div className="recommendation-card">
          ...
          <a href="https://www.indiamart.com/proddetail/shree-tricyclazole-75-wp-fungicide-25890460233.html?srsltid=AfmBOornQEUGRD6SoYiJQyUlVdT5ZTE_oC3rKrNpWBye47ePYTcrNu7j" target="_blank" rel="noopener noreferrer">Buy on Indiamart</a>
        </div>
        ...
        <div className="recommendation-card">
          ...
          <a href="https://agribegri.com/products/gharda-cutox-copper-oxychloride-50-wp-fungicide.php?srsltid=AfmBOopTIs6XXskm6Mm_GnagNqAKBhgrI7vj4S5n7b1M4MVGiU2UlONCLVs" target="_blank" rel="noopener noreferrer">Buy on AgriBegri</a>
        </div>
        ...
        <div className="recommendation-card">
          ...
          <a href="https://katyayanikrishidirect.com/products/bordeaux-mixture-fungicide?variant=46996602061096&country=IN&currency=INR&utm_medium=product_sync&utm_source=google&utm_content=sag_organic&utm_campaign=sag_organic&srsltid=AfmBOoo4d-NpVm1Yv44WJ-EA9J-s9PdnSRORZZSXvhvQavEI0H3MnZFnmrk" target="_blank" rel="noopener noreferrer">Buy on Kyatayani</a>
        </div>
